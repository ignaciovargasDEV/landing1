    ...
    >
      {props.selected && (
        <motion.div
          ...
          className="absolute inset-0 -m-px rounded-xl border border-[#0083a4]"
        ></motion.div>
      )}
      ...
      {props.isNew && (
        <div className="text-xs rounded-full px-2 py-0.5 bg-[#0083a4] text-black font-semibold">
          new
        </div>
      )}
    </div>
...
export const Features = () => {
  ...
  const backgroundPositionX = useMotionValue(tabs[0].backgroundSizeX);
